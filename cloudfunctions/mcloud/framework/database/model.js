...
class Model {
    ...
    console.log("12345",where);
		return await dbUtil.getAll(this.CL, where, fields, orderBy, size);
  }
  
  static async getAllSinger(userId, where, fields, orderBy, size = 100){
    return await dbUtil.getAllSinger(userId, this.CL, where, fields, orderBy, size);
  }
