...
MeetModel.DB_STRUCTURE = {
	...
	MEET_CATE_ID: 'int|true|comment=分类编号|default=0',
	MEET_CATE_NAME: 'string|true|comment=分类冗余|default=未设置', 
	...
	MEET_STATUS: 'int|true|default=0|comment=状态 0=未启用,1=使用中,9=停止预约,10=已关闭',
	MEET_ORDER: 'int|true|default=1',
