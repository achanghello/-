...
module.exports = {
  // 获取手机验证码
  'passport/gettestcode': 'passport_controller@gettestcode',
  // 一键登录
  'passport/oneclicklogin': 'passport_controller@oneclicklogin',
  ...
  'black/update': 'black_controller@updateBlack',
	'fav/del': 'fav_controller@delFav',
  'fav/is_fav': 'fav_controller@isFav',
  'black/is_black': 'black_controller@isBlack',
  'fav/my_list': 'fav_controller@getMyFavList',
  'black/my_list': 'black_controller@getMyBlackList',
  ...
  'meet/my_join_list_by_date': 'meet_controller@getMyJoinListByDate',
  'meet/my_join_cancel': 'meet_controller@cancelMyJoin',
  'meet/my_join_enter': 'meet_controller@editJoin',
  ...
  'admin/meet_oneclicklogin': 'admin/admin_meet_controller@oneclicklogin',
